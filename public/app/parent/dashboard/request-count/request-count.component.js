(function() {
  "use strict";
  angular.module("app").component("requestCount", {
    ...
    vm.$onInit = function() {
      d3.xhr("/logs", function(err, data) {
        ...
        var x = d3.time
          .scale()
          .domain(
            d3.extent(d3DataArray, function(d) {
              return d.time;
            })
          )
        ...
        function mousemove() {
          ...
          var x0 = x.invert(d3.mouse(this)[0]),
            ...
            compareDateValues = function(leftVal, rightVal, mouseXPosition) {
              ...
              if (leftVal && rightVal) {
                return mouseXPosition - leftVal.time >
                  rightVal.time - mouseXPosition
                  ? rightVal
                  : leftVal;
              } else {
